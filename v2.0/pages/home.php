...
<div class='page z-depth-2'>
  ...
  <div class='content'>
  	<table style='height: calc(100% - 40px)'><tbody><tr height='15%'><td colspan='2'><h4>". $_SESSION['project'] ."</h4></td></tr><tr style='height: 70%'><td colspan='2'><div style=''><canvas id='completeTasks' style='' width='650%' height='200%'></canvas></div></td></tr>
    <!--<div id='taskData'>-->
