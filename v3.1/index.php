...
<a href="#" data-target="menu-slide" class="sidenav-trigger"><i class="material-icons">menu</i></a>
<script>
  $(function() {
    if ($(window).width() < 600) {  
      $(".menu-items").addClass("sidenav");
      $('.sidenav').sidenav();
    } 
    else {
      $(".menu-items").removeClass("sidenav");
    }
    $(".menu").removeClass("hide-on-small-only");
  });
